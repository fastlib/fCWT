...
By default, the source code performs 10 runs for demonstration purposes. To match the number of runs in the paper, adjust the `runs` variable in main.cpp, line 128. It is recommended to close any background processes. 
...
fCWT is distributed under Apache 2.0 license. For conditions of distribution and use,
